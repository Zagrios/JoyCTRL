...
export type Action = { "type": "pressKeys", keys: Array<string>, } | { "type": "writeText", text: string, } | { "type": "mouseMoveDirection", direction: Direction, } | { "type": "mouseClick", button: MouseButton, } | { "type": "mouseMoveStick", mode: MouseMoveMode, } | { "type": "scrollDirection", direction: Direction, } | { "type": "scrollStick" } | { "type": "toogleMappingActive" } | { "type": "setMouseSensitivity", sensitivity: number, } | { "type": "openWebsite", url: string, } | { "type": "openFile", path: string, };
